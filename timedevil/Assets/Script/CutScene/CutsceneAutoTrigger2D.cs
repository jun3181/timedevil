// Assets/Script/Cutscene/CutsceneAutoTrigger2D.cs
using UnityEngine;

[RequireComponent(typeof(Collider2D))]
public class CutsceneAutoTrigger2D : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (debugLog) Debug.Log($"[CutsceneAutoTrigger2D] Enter -> Play('{cutsceneId}') = {ok}", this);
